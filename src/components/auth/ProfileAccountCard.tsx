  ...
  return (
    <>
      <div className="rounded-2xl border border-gray-200 bg-white p-5 md:p-6">
        ...
        {saved && (
          <div className="mt-4 rounded-lg border border-emerald-200 bg-emerald-50 px-3 py-2.5 text-sm text-emerald-800 inline-flex items-center gap-2">
            <Check size={15} />
            Password updated.
          </div>
        )}
      ...
      <Modal
        ...
        description="Update the password for your email sign-in account."
        maxWidthClassName="max-w-md"
        disableClose={saving}
        closeOnBackdrop={!saving}
      >
        <form onSubmit={(e) => void handleSubmit(e)} className="p-5 md:p-6 space-y-4">
          {error && (
          ...
          <div className="pt-2 flex flex-wrap gap-2">
            <button
              type="submit"
              disabled={saving}
              className="btn-pill-black px-5 py-2.5 text-sm disabled:opacity-60"
            >
            ...
            <button
              ...
              className="px-4 py-2.5 text-sm font-medium rounded-full border border-gray-200 text-gray-700 hover:bg-[#f5f3ef] disabled:opacity-60"
            >
              Cancel
            </button>
          </div>
